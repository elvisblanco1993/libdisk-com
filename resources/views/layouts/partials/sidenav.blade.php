<aside class="hidden md:block md:col-span-3 lg:col-span-2 py-12 text-slate-700">
    ...
    <a href="{{ route('admin.communities.index') }}" @class([
        'flex items-center space-x-2 py-2 px-2 hover:text-indigo-600',
        'text-indigo-600' => request()->routeIs('admin.communities.index'),
    ])>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
    ...
    <a href="{{ route('admin.collections.index') }}" @class([
        'flex items-center space-x-2 py-2 px-2 hover:text-indigo-600',
        'text-indigo-600' => request()->routeIs('admin.collections.index'),
    ])>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
